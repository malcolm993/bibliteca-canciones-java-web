<%-- 
    Document   : index
    Created on : 29 sep. 2023, 14:05:56
    Author     : Yair
--%>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
            <div class="container px-4">
                <a class="navbar-brand" href="#page-top">Biblioteca de Canciones</a>
            ...
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8">
                        ...
                        <p class="lead">Buscá por nombre de canción, artista o género musical.</p>
        ...
        <section class="bg-light" id="services">
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8">
                        <h3>¿No encontraste la canción que buscabas?</h3>
                        <h2>Añadila a nuestra lista</h2>
